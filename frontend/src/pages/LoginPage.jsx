...
const HandleSign = (e) => {
    ...
    mutate(undefined, {
      ...
      onError: (error) => {
        const errorMessage = error?.response?.data?.message || error.message || "logged in failed";
      ...
      <div className="card card-side bg-base-100 shadow-sm mx-w-200  ap-3 p-3">
        <div className="card-body">
          ...
          <p className="card-title text-yellow-500">
            Wellcome to Wollo University Community
          </p>
          {/* form */}
...
/>
          ...
          <div className="flex items-center justify-center">
            <p className="text-lg">
              ...
              <Link to="/signup" className="link link-primary ml-3 text-base">
                Sign UP
              </Link>
            </p>
          </div>
